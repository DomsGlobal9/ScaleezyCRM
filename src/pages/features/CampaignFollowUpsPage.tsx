...
export function CampaignFollowUpsPage() {
        ...
        <nav className="flex-1 px-4 py-6 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-1 pl-2">
              ...
              <button onClick={() => navigate('/feature/campaign-follow-ups')} className="w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-lg bg-[#243118] text-[#89b825] border-l-4 border-[#89b825] hover:bg-[#243118]/90 transition text-left">
                <span>Campaign Follow-Ups</span>
              </button>
        ...
        <header className="flex items-center justify-between h-20 px-6 bg-white border-b border-stone-200">
          <div className="flex items-center flex-1 max-w-lg gap-4">
            ...
            <div className="relative w-full">
              ...
              <input type="text" placeholder="Search campaigns..." className="w-full h-11 pl-11 pr-4 text-sm bg-[#f3e9dd] border-0 rounded-full text-stone-800 outline-none" />
            </div>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-8">
          <div className="max-w-6xl mx-auto space-y-6">
            <div className="flex items-center gap-2 text-xs font-semibold text-stone-500">
              ...
              <span>/</span>
              <span className="text-[#89b825]">Campaign Follow-Ups</span>
            </div>

            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-extrabold text-slate-900">Campaign Follow-Ups</h1>
                <p className="text-sm text-slate-500 mt-1">Broadcast promotional campaigns and measure conversion performance.</p>
              </div>
            </div>

            <div className="bg-white border border-stone-200 rounded-2xl p-6 shadow-sm text-left space-y-4">
              <div className="flex justify-between items-center p-4 bg-[#fcfaf7] border border-stone-150 rounded-xl">
                <div>
                  <h4 className="font-bold text-sm text-slate-900">Spring Festive Launch 2024</h4>
                  <p className="text-xs text-slate-500">Sent to 450 VIP customers • 84% Read Rate</p>
                </div>
                <span className="px-3 py-1 bg-[#101e12] text-[#89b825] text-xs font-bold rounded-lg">Active</span>
              </div>
            </div>
          </div>
        </div>
