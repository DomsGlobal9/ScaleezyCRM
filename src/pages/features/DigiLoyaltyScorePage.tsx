...
import { Search, Menu, X, Award, Users } from 'lucide-react';

export function DigiLoyaltyScorePage() {
        ...
        <nav className="flex-1 px-4 py-6 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-1 pl-2">
              ...
              <button onClick={() => navigate('/feature/digiloyalty-score')} className="w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-lg bg-[#243118] text-[#89b825] border-l-4 border-[#89b825] hover:bg-[#243118]/90 transition text-left">
                <span>DigiLoyalty Score</span>
              </button>
        ...
        <header className="flex items-center justify-between h-20 px-6 bg-white border-b border-stone-200">
          <div className="flex items-center flex-1 max-w-lg gap-4">
            ...
            <div className="relative w-full">
              ...
              <input type="text" placeholder="Search scores..." className="w-full h-11 pl-11 pr-4 text-sm bg-[#f3e9dd] border-0 rounded-full text-stone-800 outline-none" />
            </div>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-8">
          <div className="max-w-6xl mx-auto space-y-6">
            <div className="flex items-center gap-2 text-xs font-semibold text-stone-500">
              ...
              <span>/</span>
              <span className="text-[#89b825]">DigiLoyalty Score</span>
            </div>

            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-extrabold text-slate-900">DigiLoyalty Points & Tiers</h1>
                <p className="text-sm text-slate-500 mt-1">Manage boutique loyalty scores, point multipliers, and VIP rewards.</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm text-left space-y-2">
                <div className="flex items-center gap-2 text-amber-600 font-bold text-xs">
                  <Award size={16} />
                  <span>GOLD TIER</span>
                </div>
                <p className="text-2xl font-black text-slate-900">90+ Points</p>
                <p className="text-xs text-slate-500">Exclusive early access to bridal couture previews and free alterations.</p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm text-left space-y-2">
                ...
                <p className="text-2xl font-black text-slate-900">60 - 89 Points</p>
                <p className="text-xs text-slate-500">Complimentary home try-on deliveries and festive gifts.</p>
              </div>
              ...
              <div className="bg-white border border-stone-200 p-6 rounded-2xl shadow-sm text-left space-y-2">
                ...
                <p className="text-2xl font-black text-slate-900">0 - 59 Points</p>
                <p className="text-xs text-slate-500">Standard reward points on purchases and birthday surprise vouchers.</p>
              </div>
            </div>
          </div>
        </div>
